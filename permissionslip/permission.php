<?php 
    include('../config.php');
	 session_start();
	 $today = date('Y-m-d');
    $result = $db->query("SELECT p_id,date,code,name,TIME_FORMAT(time, '%r')time,emp_sign,status,auth_sign FROM permission_slip  WHERE DATE(date) = '$today' ORDER BY p_id DESC ");
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <!-- Divider -->
        <hr class="my-3">
        <h5>Wellcome to <?php echo $_SESSION['user']['role'];?> Page</h5>
      </div>
    </div>
  </nav>
  <!-- Main content -->
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.html">PermissionSlip</a>
        <!-- Form -->
...
setInterval(tick, 1000);
	  ...
	  <h2> <!--<a href="http://www.mostlikers.com/2017/04/ajax-add-edit-bootstrap-model-php-jquery.html"></a>--></h2></div>
      <div class="col-md-4">
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">PermissionSlip</h3>
            </div>
			...
			if(isset($_SESSION['role']) && !empty($_SESSION['role']) && $_SESSION['role']=="viari"){
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">PermissionSlip</h5>
