...
echo "---";
 ...
 if(mysqli_query($db, "INSERT INTO register(user_role_id,username,email,password,role) VALUES('".$user_role_id."','".$username."','".$email."','".$password."','".$role."')"))
 {
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form class="form" action="register.php" method="post" <?php echo '$msg';?>>
				...
				<div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="role" type="role" name="role">
                  </div>
                </div>
