<?php 
    ...
    session_start();
    $today = date('Y-m-d');
    $result = $db->query("SELECT onduty_id,date,name,code,TIME_FORMAT(time, '%r')time,out_time,place,reason,emp_sign,status,auth_sign FROM on_duty WHERE DATE(date) = '$today' ");
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="../viari.php">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.html">OnDuty Slip</a>
        <!-- Form -->
...
setInterval(tick, 1000);
      ...
      <div class="col-md-4">
        <?php $apage = array('onduty_id'=>'','date'=>'');?>
          ...
          <table class="table align-items-center table-flush">
                ...
                <?php if(isset($result) && ($data_record) > 0)  : $i=1; ?>
                    <?php  while ($users = mysqli_fetch_object($result)) { ?>
                        ...
                        <tr class="<?=$users->onduty_id?>_del">
                            
                            <td><?=$users->date;?></td>
                            <td><?=$users->name;?></td>
                            <td><?=$users->code;?></td>
                            <td><?=$users->time;?></td>
							<!--<td><?=$users->out_time;?></td>-->
							<td><?=$users->place;?></td>
							<td><?=$users->reason;?></td>
                            ...
                            <script>var page_<?php echo $users->onduty_id ?> = <?php echo json_encode($users);?></script>
                            <!--<td><a data="<?php echo 'page_'.$users->onduty_id ?>" class="model_form btn btn-info btn-sm" href="#"> <span> <i class="fas fa-edit"></i></span></a>
                            <a data="<?php echo  $users->onduty_id ?>" title="Delete <?php echo $users->date;?>" class="tip delete_check btn btn-info btn-sm "><span> <i class="fas fa-trash-alt"></i></span> </a>  
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">OnDuty</h5>
        ...
        <div class="modal-body with-padding">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <label>Out.TIME :</label>
                   <input type="out_time" name="out_time" id="out_time" class="form-control">
                </div>
              </div>
            </div>-->
			...
			<div class="form-group">
              <div class="row">
                <div class="col-sm-12">
                  <label>Place :</label>
                   <input type="place" name="place" id="place"  class="form-control" required="true">
                </div>
              </div>
            </div>
			...
			<div class="form-group">
              <div class="row">
                <div class="col-sm-12">
                  <label>Reason :</label>
				   <textarea rows="2" cols="50" name="reason" id="reason"  class="form-control" required="true" ></textarea>
                   <!--<input type="reason" name="reason" id="reason"  class="form-control" required="true">-->
                </div>
              </div>
            </div>
      ...
      <div class="modal-footer">
            ...
            <span id="add">
              <input type="hidden" name="onduty_id" value="" id="onduty_id">
