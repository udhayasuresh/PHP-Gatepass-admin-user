<?php 
    include('../config.php');
    session_start();
    $result = $db->query('SELECT onduty_id,date,name,code,TIME_FORMAT(time, "%r")time,out_time,place,reason,emp_sign,status,auth_sign FROM on_duty ORDER BY onduty_id DESC');
...
<div class="row">
      ...
      <div class="col-md-4">
        ...
        <script>var page_0 = <?php echo json_encode($apage)?></script>
		 <a href ="http://192.168.0.64/viaridash/viari.php" class="btn btn-primary back">Go Back</a>
        <p></p>
      </div>
  </div>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> OnDuty information</h4>
        </div>
        <!-- Form inside modal -->
